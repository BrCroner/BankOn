...
window.addEventListener('scroll', fixNav); // SLIDER
...
function Slider(sliderEl) {
  ...
  var prev;
  var current;
  var next; // Selecionar elementos necessários para o slider

  var slides = sliderEl.querySelector('.slides');
  var prevButton = sliderEl.querySelector('.btn-prev');
  var nextButton = sliderEl.querySelector('.btn-next');
...
var refillsSlider = Slider(document.querySelector('.slider'));
},{}],"C:/Users/bruno/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/bruno/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script.js"], null)
